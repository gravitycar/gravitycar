 ...
 */
	...
	if (strpos($_SERVER['SERVER_NAME'], "gravitycar.com") > 0)
	{
	  Configure::write('Session.database', 'live');
	}
 ...
 */
	Configure::write('Security.salt', '#XHKb(X-qmzH(Ut5B2Dj8HT9q!a0Ne)v#sbws9ir');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '4122317458417047');
